...
The first draft version will include:

1. Uploading or scaning an image of speech notes
2. Extracting text using OCR
3. Recording a practice speech
4. Converting speech to text
5. Comparing the planned notes with the spoken transcript
6. Generatign a simple report showing:
